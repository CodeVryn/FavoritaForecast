...
Для ускорения вычислений в ноутбуке favorita.ipynb была взята лишь часть данных: данные с 2016-01-01, 1000 айтемов, суммарно 20 384 690 строк. Были взяты айтемы с наибольшим количеством данных, чтобы у моделей не было проблем с недостатком данных.
